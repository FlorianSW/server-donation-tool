...
export interface DonationEvents {
    ...
    on(event: 'successfulRefund', listener: (user: RedeemTarget, order: Order) => void): this;
    ...
    on(event: 'failedRefundPerk', listener: (user: RedeemTarget, order: Order, error: RedeemError) => void): this;
    ...
    off(event: 'successfulRefund', listener: (user: RedeemTarget, order: Order) => void): this;
    ...
    off(event: 'failedRefundPerk', listener: (user: RedeemTarget, order: Order, error: RedeemError) => void): this;
}
...
export interface EventSource {
    ...
    emit(event: 'successfulRefund', user: RedeemTarget, order: Order): void;
    ...
    emit(event: 'failedRefundPerk', user: RedeemTarget, order: Order, error: RedeemError): void;
}
