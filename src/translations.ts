...
const messages: { [key: string]: string } = {
    ...
    INFO_TITLE: 'Donate',
    INFO_DESCRIPTION: 'Thanks for considering a donation to our community. Please follow this simple process to donate and get rewarded by different available perks.',
    ...
    NOTIFICATIONS_REDEEM_SUCCESSFUL_PLAYSTATION: 'PSN ID',
    NOTIFICATIONS_REDEEM_SUCCESSFUL_XBOX: 'XBox ID',
    NOTIFICATIONS_REDEEM_SUCCESSFUL_PACKAGE: 'Package name',
    NOTIFICATIONS_REDEEM_SUCCESSFUL_TYPE: 'Donation type',
    NOTIFICATIONS_REDEEM_SUCCESSFUL_PAYED_PRICE: 'Payed',
