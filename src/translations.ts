...
const messages: { [key: string]: string } = {
    ...
    DONATE_TITLE: 'Donate',
    DONATE_SUMMARY_TITLE: '1. Summary',
    DONATE_SUMMARY_PERKS_FOR_LABEL: 'Perks for:',
    DONATE_SUMMARY_PERKS_FOR_GIFT: 'As a gift',
    DONATE_SUMMARY_PERKS_FOR_YOURSELF: 'For yourself',
    DONATE_SUMMARY_USER_LABEL: 'Your information:',
    DONATE_CUSTOM_MESSAGE_TITLE: '2. Leave an optional comment',
    DONATE_CUSTOM_MESSAGE_LABEL: 'Custom message',
    DONATE_PAYMENT_TITLE: '3. Make a payment',
    DONATE_SUBSCRIBE_TITLE: '2. Subscribe',
